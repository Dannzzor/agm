...
AgmHeatmapLayer.propDecorators = {
    ...
    'dissipating': [{ type: _angular_core.Input },],
    'gradient': [{ type: _angular_core.Input },],
    'maxIntensity': [{ type: _angular_core.Input },],
    'radius': [{ type: _angular_core.Input },],
    'opacity': [{ type: _angular_core.Input },],
};
...
exports.HeatmapLayerManager = HeatmapLayerManager;
